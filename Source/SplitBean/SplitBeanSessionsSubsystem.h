...
#include "SplitBeanSessionsSubsystem.generated.h"
...
UCLASS()
class SPLITBEAN_API USplitBeanSessionsSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
	
public:
	USplitBeanSessionsSubsystem();
